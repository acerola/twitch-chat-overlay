...
export function AlertKindIcon({ kind, className, preset = "blossom" }: AlertKindIconProps) {
  if (kind === "cheer") {
    return (
      <svg className={className} viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="M8.8 10.1l1.4-2.3m3.5 1.2V6.1m3.2 3.1L18.4 7" fill="none" />
      </svg>
    );
  }
  ...
  if (kind === "gift") {
    return (
      <svg className={className} viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="M12 10v9.3M4.4 13.4h15.2" fill="none" />
  ...
  if (kind === "raid") {
    return (
      <svg className={className} viewBox="0 0 24 24" aria-hidden="true">
        <path d="M3.5 7.2h17m-14.7 0v8.2m12.4-8.2v8.2m-7-8.2v8.2m-8.2 3.4h18" fill="none" />
      </svg>
    );
  }
